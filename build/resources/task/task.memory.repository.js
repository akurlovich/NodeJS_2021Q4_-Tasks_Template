...
var getById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var idx;
    return __generator(this, function (_a) {
        idx = tasks.findIndex(function (task) { return task.id === id; });
        if (idx === -1)
            return [2 /*return*/, false];
        return [2 /*return*/, tasks[idx]];
    });
}); };
var putById = function (newUser, id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        if (idx === -1)
            return [2 /*return*/, false];
        tasks[idx] = new Task(__assign({}, newUser));
        return [2 /*return*/, tasks[idx]];
    });
}); };
...
var deleteUser = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        tasks = tasks.map(function (task) {
            if (task.userId === id) {
                var newTask = Object.assign(task, { userId: null });
                return newTask;
            }
            return task;
        });
