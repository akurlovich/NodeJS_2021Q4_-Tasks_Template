...
var getById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var idx;
    return __generator(this, function (_a) {
        idx = boards.findIndex(function (board) { return board.id === id; });
        if (idx === -1)
            return [2 /*return*/, false];
        return [2 /*return*/, boards[idx]];
    });
}); };
var putById = function (newUser, id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        idx = boards.findIndex(function (board) { return board.id === id; });
        boards[idx] = new Board(__assign({}, newUser));
        return [2 /*return*/, boards[idx]];
    });
}); };
var deleteById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                idx = boards.findIndex(function (task) { return task.id === id; });
                if (idx === -1)
                    return [2 /*return*/, false];
                return [4 /*yield*/, taskService.deleteBoard(id)];
            case 1:
                _a.sent();
                boards.splice(idx, 1);
