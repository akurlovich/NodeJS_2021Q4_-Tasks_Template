...
router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, boardsService.createBoard(req.body)];
            case 1:
                board = _a.sent();
...
router.get('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, boardsService.getById(req.params.id)];
            case 1:
                board = _a.sent();
                if (board) {
                    res.json(board);
...
router.put('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, boardsService.putById(req.body, req.params.id)];
            case 1:
                board = _a.sent();
                res.json(board);
                return [2 /*return*/];
...
router.delete('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, boardsService.deleteById(req.params.id)];
            case 1:
                status_1 = _a.sent();
                if (status_1) {
