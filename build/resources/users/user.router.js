...
router.get('/', function (_, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, usersService.getAll()];
            case 1:
                users = _a.sent();
                if (users) {
...
router.post('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, usersService.createUser((new User(req.body)))];
            case 1:
                user = _a.sent();
                if (user) {
...
router.get('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, usersService.getById(req.params.id)];
            case 1:
                user = _a.sent();
                if (user) {
...
router.put('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, usersService.putById(req.body, req.params.id)];
            case 1:
                user = _a.sent();
                if (user) {
...
router.delete('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, usersService.deleteById(req.params.id)];
            case 1:
                status_1 = _a.sent();
                if (status_1) {
